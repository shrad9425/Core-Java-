...
public class Program {
	public static void main(String[] args)throws Exception{
		...
		while( t1.thread.isAlive() || t2.thread.isAlive() || t3.thread.isAlive() || t4.thread.isAlive()) {
